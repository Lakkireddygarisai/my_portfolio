...
const Contact = () => {
  ...
  const [loading, setLoading] = useState(false);import React, { useRef, useState } from "react";
import { motion } from "framer-motion";
import {
  FaTwitter,
  FaGithub,
  ...
  return (
    <div className="xl:mt-12 flex xl:flex-row flex-col-reverse gap-10 overflow-hidden">
      ...
      >
        ...
        >
          <input type="hidden" name="to_name" value="Sairam" />
        ...
        <div className="flex gap-4 mt-8 text-center">
          <a
            href="https://twitter.com/sairam12312"
            target="_blank"
          ...
          <a
            href="https://github.com/Lakkireddygarisai"
            target="_blank"
            rel="noopener noreferrer"
          >
          ...
          <a
            href="https://www.linkedin.com/in/sairam-lakkireddy/"
            target="_blank"
            rel="noopener noreferrer"
          >
